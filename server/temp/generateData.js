...
const generateOrganisations = async () => {
  ...
  for (let i = 0; i < users.length; i += Math.floor(users.length / 3)) {
    let tempArray;
  ...
  for (let i = 0; i < 3; i++) {
    ...
    const owner =
      organisationUsers[Math.floor(Math.random() * organisationUsers.length)];
...
const generateProjects = async () => {
  ...
  for (let i = 0; i < 15; i++) {
    ...
    if (i === 0) {
      const { organisationUsers } = organisation;
    ...
    const owner = projectUsers[Math.floor(Math.random() * projectUsers.length)];
    const name = faker.random.word();
    const description = faker.random.words(20);
    const createdAt = faker.date.past();
    const updatedAt = faker.date.recent();
  ...
  for (let i = 0; i < 45; i++) {
    ...
    const owner =
      project.projectUsers[
        Math.floor(Math.random() * project.projectUsers.length)
      ];
    const name = faker.random.word();
    const description = faker.random.words(20);
